(function () {
  ...
  // header toggler-icon
  let navbarToggler5 = document.querySelector('.header .navbar-toggler');
  var navbarCollapse5 = document.querySelector('.header .navbar-collapse');

  document.querySelectorAll('.header .page-scroll').forEach((e) =>
